(function() {
    ...
    ApplicationUserDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'ApplicationUser', 'Role', 'UserGroup'];

    function ApplicationUserDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, ApplicationUser, Role, UserGroup) {
        var vm = this;
